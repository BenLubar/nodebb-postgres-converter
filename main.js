...
async function main(reader, input, output, concurrency, memory) {
	...
	await Promise.all([
		...
		query('Insert into legacy_zset', pool, 'INSERT INTO "legacy_zset" ("_key", "value", "score") SELECT l."_key", o."data"->>\'value\', (o."data"->>\'score\')::numeric FROM "legacy_object" l INNER JOIN "objects" o ON l."_key" = o."data"->>\'_key\' WHERE l."type" = \'zset\''),
