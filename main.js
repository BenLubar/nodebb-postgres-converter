...
async function main(reader, input, output, concurrency, memory) {
	...
	await Promise.all([
		...
		query('Insert into legacy_list', pool, 'INSERT INTO "legacy_list" ("_key", "array") SELECT l."_key", ARRAY(SELECT a.t FROM jsonb_array_elements_text(o."data"->\'list\') WITH ORDINALITY a(t, i) ORDER BY a.i ASC) FROM "legacy_object" l INNER JOIN "objects" ON l."_key" = o."data"->>\'_key\' WHERE l."type" = \'list\''),
